...
app.get('/', (req, res) => {
  ...
  const rowTwoArray = [[65, "A", "VOX 1"], [83, "S", "VOX 2"], [68, "D", "VOX 3"], [70, "F", "VOX 4"], [71, "G", "Bmaj (VI)"], [72, "H", "C#maj (VII)"], [74, "J", "D#min (i)"], [75, "K", "Bbmin (v)"]];
  const rowThreeArray = [[90, "Z", "INTRO DRUMS"], [88, "X", "VERSE DRUMS"], [67, "C", "BUILD DRUMS"], [86, "V", "DROP DRUMS"], [66, "B", "Bmaj (VI)"], [78, "N", "C#maj (VII)"], [77, "M", "D#min (i)"], [188, "<", "Bbmin (v)"]];
